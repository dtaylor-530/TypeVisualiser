namespace TypeVisualiser.Model.Persistence
{
    ...
    /// </summary>
    public class VisualisableTypeWithAssociationsDataAdaptor : IVisualisableTypeWithAssociationsDataAdaptor
    {
        /// <summary>
        ...
        {
            private IVisualisableTypeData data;

            public event EventHandler DataReady;

            public IVisualisableTypeData Data
            {
                get
                {
                    return this.data;

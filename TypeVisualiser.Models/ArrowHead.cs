...
namespace TypeVisualiser.Model
{
    ...
    /// </summary>
    public abstract class ArrowHead : IDiagramContentFunctionality, INotifyPropertyChanged
    {
        ...
        {
            List<IDiagramElement> elementList = dependentElements.ToList();
            IDiagramElement route = elementList.FirstOrDefault(x => x.DiagramContent is ConnectionLine);
            if (route == null)
            {
                return;
            }
